      ...
      body: ListView(
        children: [
          Container(
            ...
            child: Column(
              children: [
                Text("Total Harga: Rp. ${widget.total}")
              ],
            ),
          ),
          Container(
          ...
          ElevatedButton(
            ...
            if(buktiFoto != null){
              ...
              SplashScreen(pesan: 'PEMBAYARAN BERHASIL,\nMENUNGGU KONFIRMASI PENJUAL', navigator: Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) {return ProdusenTransaksi();}), (route) => false));
            }
          }, child: Text("Bayar"))
        ],
      ),
